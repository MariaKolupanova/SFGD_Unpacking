...
{   
    ...
    int FEBcalib[NumberOfFEB][6];
    string fintxtLG = "LG_ToT_calib/LG_ToT_dist.txt";
    ifstream finDatLG(fintxtLG.c_str());
    cout << "Taking fit parrameters at "<< fintxtLG<<endl;
    int temp=0;
    while (temp<NumberOfFEB && !finDatLG.eof()) {
        finDatLG >> FEBcalib[temp][0] >> FEBcalib[temp][1] >> FEBcalib[temp][2] >> FEBcalib[temp][3] >> FEBcalib[temp][4] >> FEBcalib[temp][5];
        temp++;
    }   
    finDatLG.close();
    ...
    for (Int_t ih=0; ih<NumberOfFEB; ih++) {
        ...
        while (!gain.eof()) {
            gain >> temp >> ChannelGain[0][temp] >>trash>> ChannelGain[1][temp];
            //cout << temp <<" "<< ChannelGain[0][temp] << " "<<ChannelGain[1][temp] << " "<<trash<<endl;
        }
        gain.close();
        ...
        for ( Int_t iev=0; iev < FEB[ih].FEBSN->size(); iev++){
            ...
            if (FEB[ih].hitTimeDif->at(iev) > 0 && FEB[ih].hitTimeDif->at(iev) < FEBcalib[ih][1]){
            ...
            } else if (FEB[ih].hitTimeDif->at(iev) >= FEBcalib[ih][1] && FEB[ih].hitTimeDif->at(iev) < FEBcalib[ih][3]){
            ...
            } else if (FEB[ih].hitTimeDif->at(iev) >= FEBcalib[ih][3]){
            ...
            if (FEB[ih].hitTimeDif->at(iev) > 0 && FEB[ih].hitTimeDif->at(iev) < 8){
            ...
            } else if (FEB[ih].hitTimeDif->at(iev) >=8 && FEB[ih].hitTimeDif->at(iev) < 22){
            ...
            } else  if (FEB[ih].hitTimeDif->at(iev) >=22){
            ...
            //if (FEB[ih].hitTimeDif->at(iev)<100 && FEB[ih].hitTimeDif->at(iev) > 0 && (FEB[ih].hitAmplMatched->at(iev) < 1 || FEB[ih].hitAmplMatched->at(iev) > 2500)) {
            if (FEB[ih].hitTimeDif->at(iev)<700 && FEB[ih].hitTimeDif->at(iev) > 0 ) {
                FEB[ih].hitAmplRec.push_back(reconHG);
            } else {
                FEB[ih].hitAmplRec.push_back(FEB[ih].hitAmplMatched->at(iev));
            }

            if (FEB[ih].hitTimeDif->at(iev)<700 && FEB[ih].hitTimeDif->at(iev) > 0 ) {
                FEB[ih].hitLGAmplRec.push_back(reconLG);
            } else {
                FEB[ih].hitLGAmplRec.push_back(FEB[ih].hitLGAmplMatched->at(iev));
            }
            
            double reconHG_pe, reconLG_pe, reconToT_pe;

            //making hitHG_pe
            if (FEB[ih].hitAmplMatched->at(iev)>1){
              reconHG_pe = (FEB[ih].hitAmplMatched->at(iev) - ChannelGain[1][(int)FEB[ih].hitsChannel->at(iev)]) / ChannelGain[0][(int)FEB[ih].hitsChannel->at(iev)];
            ...
            //making hitLG_pe
            if (FEB[ih].hitLGAmplMatched->at(iev)>1){
              reconLG_pe = (((FEB[ih].hitLGAmplMatched->at(iev) - fitParHG[(int)FEB[ih].hitsChannel->at(iev)][0])/fitParHG[(int)FEB[ih].hitsChannel->at(iev)][1]) - ChannelGain[1][(int)FEB[ih].hitsChannel->at(iev)]) / ChannelGain[0][(int)FEB[ih].hitsChannel->at(iev)];
            ...
            //making hitToT_pe
            if (FEB[ih].hitTimeDif->at(iev) > 1 && FEB[ih].hitTimeDif->at(iev) < 23){
              reconToT_pe = (FEB[ih].hitAmplRec.back() - ChannelGain[1][(int)FEB[ih].hitsChannel->at(iev)]) / ChannelGain[0][(int)FEB[ih].hitsChannel->at(iev)];
              FEB[ih].hitToT_pe.push_back(reconToT_pe);
            } else if (FEB[ih].hitTimeDif->at(iev) >= 23) {
              reconToT_pe = (((FEB[ih].hitLGAmplRec.back() - fitParHG[(int)FEB[ih].hitsChannel->at(iev)][0])/fitParHG[(int)FEB[ih].hitsChannel->at(iev)][1]) - ChannelGain[1][(int)FEB[ih].hitsChannel->at(iev)]) / ChannelGain[0][(int)FEB[ih].hitsChannel->at(iev)];
              FEB[ih].hitToT_pe.push_back(reconToT_pe);
            } else {
              reconToT_pe = -1;
              FEB[ih].hitToT_pe.push_back(reconToT_pe);
            ...
            //making hitCharge_pe
            /*if (reconHG_pe>0 && FEB[ih].hitAmplMatched->at(iev)<3500){
              FEB[ih].hitCharge_pe.push_back(reconHG_pe);
            } else if (reconLG_pe>0 && FEB[ih].hitLGAmplMatched->at(iev) < 2500){
              FEB[ih].hitCharge_pe.push_back(reconLG_pe);
            } else if (reconToT_pe > 0){
