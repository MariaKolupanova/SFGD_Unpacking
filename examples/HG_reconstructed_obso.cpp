...
{   
    ...
    for (Int_t ih=0; ih<NumberOfFEB; ih++) {
        ...
        for ( Int_t iev=0; iev < FEB[ih].FEBSN->size(); iev++){
            ...
            //making hitHG_pe
            if (FEB[ih].hitAmpl->at(iev)>1){
              reconHG_pe = (FEB[ih].hitAmpl->at(iev) - ChannelGain[1][(int)FEB[ih].hitsChannel->at(iev)]) / ChannelGain[0][(int)FEB[ih].hitsChannel->at(iev)];
            ...
            //making hitLG_pe
            if (FEB[ih].hitLGAmpl->at(iev)>1){
              reconLG_pe = (((FEB[ih].hitLGAmpl->at(iev) - fitParHG[(int)FEB[ih].hitsChannel->at(iev)][0])/fitParHG[(int)FEB[ih].hitsChannel->at(iev)][1]) - ChannelGain[1][(int)FEB[ih].hitsChannel->at(iev)]) / ChannelGain[0][(int)FEB[ih].hitsChannel->at(iev)];
